...
namespace MovieSorterApp1
{
    public partial class Popup : Form
    {
        ...
        private async void Popup_Load(object sender, EventArgs e)
        {
            ...
            Image poster = await Task.Run(() => Image.FromFile(movie.Poster));
            Image backdrop = await Task.Run(() => Image.FromFile(movie.Backdrop));

            pictureBoxPoster.Image = poster;
            panelBackdrop.BackgroundImage = backdrop;
